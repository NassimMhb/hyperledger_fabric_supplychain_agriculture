...
export class ClientComponent implements OnInit {
  ...
  vorder = new FormControl('', Validators.required);
  ...
  addParticipant(form: any): Promise<any> {
    this.participant = {
      $class: 'org.agriculture.model.supplychain.Client',
      'vorder': this.vorder.value,
      'uid': this.uid.value,
   ...
   updateParticipant(form: any): Promise<any> {
    ...
    return this.serviceClient.updateParticipant(form.get('uid').value, this.participant)
    .toPromise()
    .then(() => {
      this.errorMessage = null;
      this.loadAll();
  ...
  getForm(id: any): Promise<any> {
    ...
    .then((result) => {
      ...
      if (result.vorder) {
        formObject.vorder = result.vorder;
      } else {
        formObject.vorder = null;
      }
